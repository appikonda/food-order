  ...
  render() {
    return (
      ...
      <Grid container spacing={5}>
        ...
        <Grid item xs={6} sm={3}  >
          <Paper style={{      textAlign: 'center',      color: '#212121', height: '40vh'  }}>No   For each item there will be heading 
  And discription 
...
renderGridOptions(){
  ...
  return (
    ...
    <Grid container spacing={5}>
        ...
        <Grid item xs={6} sm={3}  >
          <Paper style={{      textAlign: 'center',      color: '#212121'  }}>No   For each item there will be heading 
  And discription 
  And button to order</Paper>
        </Grid>
        <Grid item xs={6} sm={3} >
